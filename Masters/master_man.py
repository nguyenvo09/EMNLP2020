...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_neg', default = 4, type = int,  help = 'num negs per positive candidate')
    ...
    parser.add_argument('--fixed_length_left', type = int, default = 2000, help = 'Maximum length of each query')
    parser.add_argument('--fixed_length_right', type = int, default = 7300, help = 'Maximum length of each document')
